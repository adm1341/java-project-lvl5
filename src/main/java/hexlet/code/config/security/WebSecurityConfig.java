...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private final TokenAuthenticationProvide authenticationProvider;

    public WebSecurityConfig(@Value("${base-url}") final String baseUrl,
                             @Lazy final TokenAuthenticationProvide authenticationProvider) {
        ...
        this.publicUrls = new OrRequestMatcher(
                ...
                new AntPathRequestMatcher(baseUrl + AuthController.LOGIN, POST.toString()),
